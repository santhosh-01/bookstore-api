...
//        if( !(request.getRequestURI().contains("login") || request.getRequestURI().contains("signup") || request.getRequestURI().contains("swagger") || request.getRequestURI().contains("api-docs") || request.getRequestURI().contains("configuration") || request.getRequestURI().contains("webjars"))){
        if(request.getRequestURI().contains("privateApi") || request.getRequestURI().contains("allbooks")) {
